<template>
  <v-container>
    ...
    <p>
      ...
      <br>
      Zusätzlich sollte die Anwendung eine kleine eigene Scriptsprache mitbringen, mit welcher man ja nach noch verfügbarer Zeit des Countdowns den eben genannten Text mit Platzhaltern zu steuern.<br>
...
export default {
  head () {
    return {
      title: 'Projekt: Stream Countdown'
    }
  }
}
</script>
